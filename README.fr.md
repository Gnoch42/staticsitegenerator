...
l'impression, un template à colonnes garde sa colonne latérale, et le contenu
principal occupe toute la largeur une fois la sidebar terminée (pas de colonne vide
réservée sur les pages suivantes).
